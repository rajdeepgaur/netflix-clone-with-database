...
import { Container, Group, Title, SubTitle, Item, Meta, Text, Image, Entities, Feature, FeatureTitle, FeatureText, FeatureClose, Maturity,Content } from './styles/card';
...
export default function Card({ children, ...restProps }){
   ...
   const [showFeature, setShowFeature] = useState(false);
    ...
    return <FeatureContext.Provider value={{ itemFeature, setItemFeature, showFeature, setShowFeature}}>
...
Card.Title = function CardTitle({ children, ...restProps }){
 ...
 Card.Item = function CardItem({ setTrailer, item, children, ...restProps }){
